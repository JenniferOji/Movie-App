...
export default function Edit(props) {
  /* This hook is provided by React Router and allows you to access the dynamic parameters of the current route. 
  * In this case, useParams is used to get the id of the movie from the URL, allowing us to retrieve the specific movie data from the database. 
  * This makes it possible to load and edit details for a single, specific movie.*/
  let { id } = useParams(); //populate id
   ...
   * Here, it is used after the user submits the edited movie information.
...
//when this ocmponent becomes active it goes off and reads a movie back by its id
useEffect(() => {
